...
author: "Autor: Deiverson Almeida"
date: "`r suppressMessages(suppressWarnings(library(tidyverse))); paste0(str_to_title(format(Sys.Date(), '%A, %d ')), 'de ', str_to_title(format(Sys.Date(), '%B ')), 'de ', str_to_title(format(Sys.Date(), '%Y')))`"
